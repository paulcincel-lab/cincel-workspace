  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        type: "boolean",
        getValue: (capabilities) => (capabilities as ActivitiesCapabilities).canExportData,
      },
      {
        id: "statusScope",
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        label: "Exportar datos",
        type: "boolean",
        getValue: (capabilities) => (capabilities as ProjectsCapabilities).canExportData,
      },
    ],
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        label: "Exportar datos",
        type: "boolean",
        getValue: (capabilities) => (capabilities as ClientsCapabilities).canExportData,
      },
    ],
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        label: "Exportar datos",
        type: "boolean",
        getValue: (capabilities) => (capabilities as TeamCapabilities).canExportData,
      },
    ],
